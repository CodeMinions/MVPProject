package me.codeminions.mvpproject.contractMVP
...
import me.codeminions.factory.main.PresenterActivity
...
class MainActivity : PresenterActivity(), LoginContract.View, LoadContract.View {
    ...
    override fun initWidget() {
        ...
        btnClean.setOnClickListener { mPresenter.clean() }
        // 点击进度条取消加载
        loading.setOnClickListener { mPresenter.cancel("LOGIN PIC") }
    ...
    override fun onLoginFail(info: String) {
        Toast.makeText(this, "Login Fail ($info)", Toast.LENGTH_SHORT).show()
    }
